			...
			<li data-effect="<?php echo $data['index']['set_img_effect_'.$key]; ?>">
				<a href="#">
					<img class="img-responsive"
						src="widgets/sliderpoc/images/assets/spacer.png" data-src="<?php echo path($data['images'][$key-1]['file_id']); ?>" data-thumb="<?php echo path($data['images'][$key-1]['thumbnail_file_id']); ?>" data-toggle="tooltip" title="<?php echo $data['images'][$key-1]['title']; ?>" />
				</a>
